...
public class Lista<T> extends ArrayList { // Só usei o ArrayList na (1 letra "c") método GET
    private T[] elementos;
    ...
    public boolean inverte(){
        ...
        for (int i = tamanho-1; i >= 0; i--) {
            this.elementosJ[j] = this.elementos[i];
            j++;
        }
        j = 0;
        for (int i = 0; i <= tamanho-1; i++) {
            this.elementos[j] = this.elementosJ[i];
            j++;
        }
        return true;
    }
